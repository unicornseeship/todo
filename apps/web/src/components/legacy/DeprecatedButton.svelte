...
<div
	...
	data-style={style}
>
	<LinkOrButton {href} on:click={() => dispatch('click')} {type} {target} {tabIndex} {disabled}>
		{#if loading}
			<span class="spinner">
				<Icon icon="spinner" />
			</span>
...
<style type="text/scss">
	...
	div[data-style='primary'] > :global(*) {
		...
		background-color: var(--deprecated-button-primary-background-color) !important;
	}
	...
	div[data-style='secondary'] > :global(*) {
		...
		background-color: var(--deprecated-button-secondary-background-color) !important;
	}
